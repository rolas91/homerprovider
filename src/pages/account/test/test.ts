...
export class test {
    ...
    filter: any;
    resultCartMembership: any;

    constructor(private inAppBrowser: InAppBrowser, public categoryService: CategoryService, public toastCtrl: ToastController, public nav: NavController, public service: Service, public values: Values) {
        this.items = [];
        this.options = [];
